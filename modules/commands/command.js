...
const loadCommand = function ({ moduleList, threadID, messageID }) {
    ...
    //modified context
    const loadedModulesCount = moduleList.length - errorList.length;
    const modulePlural = loadedModulesCount === 1 ? 'module' : 'modules';
    const message = `Loaded ${loadedModulesCount} ${modulePlural} ✅`;
