module.exports.config = {
  ...
  description: "Send random cat pics",
  hasPermssion: 0,
...
module.exports.run = async function({
  ...
  try {
      let data = await axios.get('https://sensui-useless-apis.codersensui.repl.co/api/fun/catpic');
      var fileExtension = path.extname(data.data.picture); // Extract the file extension from the URL
      var fileName = `cat${fileExtension}`; // Create a file name with the correct extension
