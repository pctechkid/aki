module.exports.config = {
	...
	credits: "Aki Hayakawa", // Công nhận module sở hữu là ai
	description: "Flip the coin", // Thông tin chi tiết về lệnh
	usePrefix: true,
...
return (Math.random() > 0.5) ? api.sendMessage("Face Down", event.threadID, event.messageID) : api.sendMessage("Face Up", event.threadID, event.messageID);
