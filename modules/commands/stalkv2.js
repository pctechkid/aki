...
module.exports.run = async function({api, event, args, utils, Users, Threads}) {
    try {
        ...
        const profilePic = path.join(__dirname, `/cache/${id}.png`);
        ...
        fs.writeFileSync(profilePic, Buffer.from(avatarResponse.data, 'utf-8'));
        ...
        api.sendMessage({
            ...
            attachment: fs.createReadStream(profilePic)
        }, event.threadID, () => fs.unlinkSync(profilePic), event.messageID);

        // request(encodeURI(`https://graph.facebook.com/${id}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`))
