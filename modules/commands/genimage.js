...
module.exports.run = async function({ api, event, args }) {
    ...
    if(keySearch.includes("-") == false) return api.sendMessage('Invalid input!\nUsage: '+global.config.PREFIX+this.config.name+' mark zuckerberg - 10', event.threadID, event.messageID);
    ...
    api.sendMessage({
        attachment: imgData,
        body: "Showing"+numberSearch+' AI-generated images for '+ keySearchs
